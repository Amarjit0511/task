...
object TaskSix {
  def main(args: Array[String]): Unit = {
    ...
    val csvPath = "/home/xs334-amakum/Downloads/CSV/T1*.csv"
    ...
    val topicDF = csvDF
      ...
      .option("sep", ",")
      .option("checkpointLocation", "/home/xs334-amakum/Downloads/CheckpointTopic/")
   ...
   // transformedDF.show()
    ...
    val deltaPath = "/home/xs334-amakum/Downloads/Tables"
    transformedDF.writeStream
      .format("delta")
      .outputMode("append")
      .option("checkpointLocation", "/home/xs334-amakum/Downloads/CheckpointDelta")
      .start(deltaPath)
  ...
  //  datapointsPerDay.show()
    ...
    val averageSignalsPerHour = deltaDF
      ...
      .agg(avg("signals.LV ActivePower (kW)").alias("average_LV_ActivePower"),
